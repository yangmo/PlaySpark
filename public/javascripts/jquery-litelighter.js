...
(function($){
	...
	$.litelighter.languages.errorlog = {
			date: { re: /([a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12})/gi, style: 'date'},
			keywords: { re: /(?:\b)(ERROR|\(.*?\.java:\d+\)|INFO|application\.log)/gi, style: 'keyword' }
	};
